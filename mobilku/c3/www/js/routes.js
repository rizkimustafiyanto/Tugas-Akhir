var routes = [
  ...
  // Antrian
  {
    path: '/antrian/', componentUrl: 'pages/antrian/antrian.html',
  },
  // Detail Antrian
  {
    path: '/detailantrian/', componentUrl: 'pages/detail_antrian.html', options: {
      transition: 'f7-circle',
    },
  },
  // Profil
  {
    path: '/datauser/', componentUrl: 'pages/datauser.html',
  },
  // Register
  {
    path: '/register/', componentUrl: 'pages/create/register.html',
  },
  //Data Poli
  {
    path: '/datapoli/', componentUrl: 'pages/datapoli.html',
  },
  // Update
  {
    path: '/kelolauser/', componentUrl: 'pages/edit/kelolauser.html',
  },
  // Daftar Antri
  {
    path: '/daftartiket/', componentUrl: 'pages/create/daftartiket.html',
  },
  // Lihat Tiket
  {
    path: '/lihattiket/', componentUrl: 'pages/lihattiket.html',
  },
  // Lihat Tiketnya
  {
    path: '/tiketuser/', componentUrl: 'pages/tiket/tiket.html',
  },
  //Jadwal Dokter
  {
    path: '/jadwaldokter/', componentUrl: 'pages/jadwaldokter.html',
  },
  // Right Panel pages
  {
